...
// spatial derivatives. Compared with linear, linear2 solve the equation more complex
// that dw/dt = laplace(w) - w with initial condition w = exp( -1*(r^2)/2)(assume that origin 
// at the center). 
int main(){
